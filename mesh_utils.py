...
def decimate_mesh(
    ...
    print(
        f"[LOGS] mesh decimation: {_ori_vert_shape} --> {verts.shape}, {_ori_face_shape} --> {faces.shape}"
    )
...
def clean_mesh(
    ...
    print(
        f"[LOGS] mesh cleaning: {_ori_vert_shape} --> {verts.shape}, {_ori_face_shape} --> {faces.shape}"
    )
